 ...
 * @description Manages API base URLs and settings
 */
 ...
 * @description Used for endpoints under /api/v1/external/
 */
 ...
 * @description Used for endpoints under /api/v1/internal/
 */
